...
public class FileTypeManagementController {
    ...
    public void addFileType(@Valid @RequestBody FileTypeManagement newFileType) {
   ...
   // public ResponseEntity<String> updateFileType(@Valid @RequestBody FileTypeManagement newFileType, @PathVariable("fileTypeCode") String fileTypeCode) {
    ...
    public void updateFileType(@Valid @RequestBody FileTypeManagement newFileType, @PathVariable("fileTypeCode") String fileTypeCode) {
